  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed top-4 right-4 z-50 transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary/20 rounded-full"
      ...
      <header 
        className={`fixed top-0 left-0 w-full z-40 transition-all duration-classic ${
